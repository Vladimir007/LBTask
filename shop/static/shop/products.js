...
function get_products_table(url) {
    if (!url) return false;
...
$(document).ready(function () {
    let page_api_url = '/shop-api/products/';
    get_products_table(page_api_url);
    $('#products_table').show();

    $('.pagination-btn').click(function () {
        get_products_table($(this).data('href'));
    });
